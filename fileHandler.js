...
import { countAllItemsRecursive, getFormattedTimestamp } from "./utils.js";
  ...
  reader.onload = (event) => {
    try {
      ...
      if (
        ...
        // This is a raw inventory file, load it directly with default filters
        ...
        // This is a saved checklist file, load it directly
        state.setFullInventoryData(state.tempLoadedData);
        ...
        renderChecklist();
        updateCheckedItemsOverlay();
        dom.loadStatus.textContent = `Checklist caricata.`;
        state.setTempLoadedData(null);
        state.setHasUnsavedChanges(false);
